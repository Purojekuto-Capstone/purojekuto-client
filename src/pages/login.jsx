            ...
            <div className={`main__container `}>
              <div className="login__container">
                ...
                <a href="https://purojekuto-backend.herokuapp.com/login">
                  ...
                  <p className="terms">
                    By Sign In you need to read and accept{' '}
                    <a href="https://termify.io/terms-and-conditions-generator">
                      Terms and Condicions
                    </a>{' '}
                  </p>
                </a>

                <p className="login__container--p2"> </p>
              </div>
            </div>
          </div>
      </>
