...
const newProyect = () => {
  ...
  const DetailProject = () => (
    <div className="container form__container">
      ...
      <label className="mb-1">
        How much time will you invert on it?<i>(weekly).</i>
      </label>
      <input
        {...register('work_time')}
        className="input"
      ...
      <label className="mb-1">
        How much time will you rest?<i>(daily)</i>
      </label>
      <input
        {...register('break_time')}
        className="input"
      ...
      <input {...register('start_date')} className="input" type="date"></input>
      <label className="mb-1">When will you end it?</label>
      <input {...register('end_date')} className="input" type="date"></input>
  ...
  return (
    <>
      <Head>
        <title>New project | PuroJekuto</title>
      </Head>
      <Layout>
